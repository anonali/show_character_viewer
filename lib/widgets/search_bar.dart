...
// import 'package:marvel/src/simpsons.dart' as simpsons;

// import '../marvel.dart' as marvel;
import '../repositories/characters_repository.dart' as repository;
import '../models/freezed_repository_models.dart' as freezed_model;
...
class _SearchHints extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final count = ref.watch(repository.charactersCount(search));
      ...
      itemBuilder: (context, index) {
        return HookConsumer(
          builder: (context, ref, child) {
            final character = ref.watch(repository.characterAtIndex(
              freezed_model.CharacterOffset(offset: index, text: search),
            ));

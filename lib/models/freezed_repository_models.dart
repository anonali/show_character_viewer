...
part 'freezed_repository_models.freezed.dart';
part 'freezed_repository_models.g.dart';
...
// Represents a response containing a list of characters.
@freezed
class CharactersListResponse with _$CharactersListResponse {
  factory CharactersListResponse({
    required List<NewCharacter> characters, // List of characters.
    required int totalCount, // Total count of characters.
